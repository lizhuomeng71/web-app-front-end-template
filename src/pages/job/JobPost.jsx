          ...
          <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                ...
                <div className="mb-2 text-sm text-gray-500 italic dark:text-gray-400">
                  Posted Jan 6, 2024
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      <div className="mr-4 text-sm text-gray-500 italic dark:text-gray-400">
                        Share:
                      </div>
                ...
                {/* Related Jobs */}
                <div>
                  <h2 className="mb-6 text-xl leading-snug font-bold text-gray-800 dark:text-gray-100">
                    Related Jobs
                  </h2>
