          ...
          <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className="mb-8 sm:flex sm:items-center sm:justify-between">
                ...
                <div className="grid grid-flow-col justify-start gap-4 sm:auto-cols-max sm:justify-end">
                  ...
                  <div className="-ml-px flex shrink-0 -space-x-3">
                    ...
                    <button className="ml-2 flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white text-violet-500 shadow-xs transition hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:hover:border-gray-600">
              ...
              <div className="space-y-6">
                {/* Group 1 */}
                <div>
                  <h2 className="mb-4 grow truncate font-semibold text-gray-800 dark:text-gray-100">
                    To Do's
                  </h2>
                  <div className="space-y-2">
                    {/* Task */}
                    <div
                      className="rounded-xl bg-white p-4 shadow-xs dark:bg-gray-800"
                      draggable="true"
                    >
                        ...
                        <div className="mt-0.5 mb-3 grow space-y-3 sm:mb-0">
                          <div className="flex items-center">
                            ...
                            <label className="flex items-center">
                              <input
                                type="checkbox"
                                className="form-checkbox peer h-5 w-5 rounded-full"
                              />
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {/* Task */}
                    <div
                      className="rounded-xl bg-white p-4 opacity-60 shadow-xs dark:bg-gray-800"
                      draggable="true"
                    >
                      <div className="sm:flex sm:items-start sm:justify-between">
                        {/* Left side */}
