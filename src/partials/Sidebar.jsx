        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Inbox */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${pathname.includes('inbox') && 'from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]'}`}
              >
                <NavLink
                  end
                  to="/inbox"
              ...
              {/* Calendar */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${pathname.includes('calendar') && 'from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]'}`}
              >
                <NavLink
                  end
                  to="/calendar"
              ...
              {/* Campaigns */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${pathname.includes('campaigns') && 'from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]'}`}
              >
                <NavLink
                  end
                  to="/campaigns"
