...
function ChannelMenu() {
  ...
  return (
    <div className="relative">
      ...
      <Transition
        className="absolute top-full left-0 z-10 mt-1 min-w-60 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white py-1.5 shadow-lg dark:border-gray-700/60 dark:bg-gray-800"
        show={dropdownOpen}
