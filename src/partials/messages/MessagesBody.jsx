  ...
  return (
    <div className="grow px-4 py-6 sm:px-6 md:px-5">
      ...
      <div className="mb-4 flex items-start last:mb-0">
        ...
        <div>
          <div className="flex items-center">
            <img
              className="mb-1 rounded-lg shadow-xs"
              src={ChatImage}
              width="240"
              height="180"
              alt="Chat"
      ...
      <div className="flex justify-center">
        <div className="my-5 inline-flex items-center justify-center rounded-full bg-white px-2.5 py-1 text-xs font-medium text-gray-600 shadow-xs dark:bg-gray-700 dark:text-gray-400">
          Tuesday, 20 January
        </div>
      </div>
      {/* Chat msg */}
